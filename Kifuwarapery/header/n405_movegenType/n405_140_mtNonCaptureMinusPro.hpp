...
/// 
/// </summary>
class MovegenTypeNonCaptureMinusPro : public MovegenTypeAbstract {
...
public:
	...
	DeliciousBanana* GenerateMove(DeliciousBanana* moveStackList, const Position& pos, bool all = false
		...
		{
			moveStackList = MovegenTypeNonCaptureMinusPro::GENERATE_MOVE_<Color::Black, Color::White>(moveStackList, pos, all);
		}
		else
		{
			moveStackList = MovegenTypeNonCaptureMinusPro::GENERATE_MOVE_<Color::White, Color::Black>(moveStackList, pos, all);
		}
...
private:
	...
	static inline DeliciousBanana* GENERATE_MOVE_(DeliciousBanana* moveStackList, const Position& pos, bool all = false
		...
		const PieceMoveEvent pmEvent(MovegenType::N04_NonCaptureMinusPro, all, pos, ksq);
