...
/// 
/// </summary>
class MovegenTypeCapturePlusPro : public MovegenTypeAbstract {
...
public:
	...
	DeliciousBanana* GenerateMove(DeliciousBanana* moveStackList, const Position& pos, bool all = false
		...
		{
			moveStackList = MovegenTypeCapturePlusPro::GENERATE_MOVE_<Color::Black, Color::White>(moveStackList, pos, all);
		}
		else
		{
			moveStackList = MovegenTypeCapturePlusPro::GENERATE_MOVE_<Color::White, Color::Black>(moveStackList, pos, all);
		}
...
private:
	...
	static inline DeliciousBanana* GENERATE_MOVE_(DeliciousBanana* moveStackList, const Position& pos, bool all = false
		...
		const PieceMoveEvent pmEvent(MovegenType::N03_CapturePlusPro, all, pos, ksq);
