...
private:
	...
	{
		if (record == "-") { return; }	// "-" なら棋譜ファイルを読み込まない。
	...
	/// <param name="blackRecordFileName"></param>
	/// <param name="whiteRecordFileName"></param>
	/// <param name="gameNum"></param>
	...
	void setLearnOptions(MuzGameEngineStorageModel& s) {
		std::string m_engineSettings[] = {"name Threads value 1",
								 "name MultiPV value 1",
								 "name OwnBook value false",
								 "name Max_Random_Score_Diff value 0"};
		for (auto& str : m_engineSettings) {
	...
	/// <typeparam name="UsePenalty"></typeparam>
	/// <param name="v"></param>
