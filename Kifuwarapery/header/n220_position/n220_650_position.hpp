...
#include "../n130_100_boardBb_/n160_102_FileMaskBb.hpp"
#include "../n130_100_boardBb_/n160_106_inFrontMaskBb.hpp"
#include "../n130_100_boardBb_/n160_240_betweenBb.hpp"
...
public:
	...
	Position(const Position& pos, Monkey* th);

	Position(const std::string& sfen, Monkey* th, OurCarriage* s);
	...
	/// 
	/// </summary>
	static void initialize_10a490b_zobrist();
