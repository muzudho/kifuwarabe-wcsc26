...
#include "../../header/n130_100_boardBb_/n160_170_goldAndSilverAttackBb.hpp"
...
/// </summary>
/// <returns></returns>
MonkeyAbstract* Position::GetThisThread() const
{
...
void Position::DoMove(const Move move, StateInfo& newSt, const CheckInfo& ci, const bool moveIsCheck) {
	...
	if (move.IsDrop()) {
		...
		if (moveIsCheck) {
			...
			{
				g_bonaMoveArray[g_squareRelation.GetSquareRelation(from, ksq)]->Do2Move(*this, from, ksq, US);
...
/// <param name="pos"></param>
/// <param name="th"></param>
Position::Position(const Position & pos, MonkeyAbstract * th)
{
	*this = pos;
...
/// <param name="th"></param>
/// <param name="s"></param>
Position::Position(const std::string & sfen, MonkeyAbstract * th, OurCarriage * s)
{
	this->Set(sfen, th);
...
/// <param name="sfen"></param>
/// <param name="th"></param>
void Position::Set(const std::string& sfen, MonkeyAbstract* th) {
