...
/// </summary>
/// <returns></returns>
ScoreNumber TTEntry::GetScore() const
{
	return static_cast<ScoreNumber>(this->m_score16_);
}
...
/// </summary>
/// <returns></returns>
ScoreNumber TTEntry::GetEvalScore() const
{
	return static_cast<ScoreNumber>(this->m_evalScore_);
}
...
void TTEntry::SetSave(const Depth depth, const ScoreNumber score, const Move move, const u32 posKeyHigh32, const Bound bound, const u8 generation, const ScoreNumber evalScore)
{
